...
<meta charset="utf-8">
<title>秦浩雷的简历-拉勾网-最专业的互联网招聘平台</title>
		...
		<div class="mr_myresume_l mrcenter">
			<div id="mr_mr_head">
				<div class="m_portrait mr_top_bg">
					...
					<img src="http://www.lagou.com/image1/M00/44/6E/Cgo8PFXViSSAG9gxAAAsFOk6PHs447.jpg" width="120" height="120" alt="" />
				</div>
				<div class="mr_baseinfo">
					<i class="mr_left_bg"></i>
					<i class="mr_right_bg"></i>
					<div class="mr_p_name mr_w604 clearfixs">
						<span class="mr_name">秦浩雷</span>
					</div>
					<div class="mr_p_introduce mr_w604 clearfixs">
						<span class="mr_intro">Stay hungry. Stay foolish</span>
					</div>
					<div class="mr_p_info mr_infoed mr_w604 clearfixs">		
						...
						<div class="info_t">
							...
							<span class="job_span">&nbsp;&nbsp;应届毕业生</span><span class="birth_span dn">1992.10年出生</span>&nbsp;&nbsp;&nbsp;潍坊</span>
						</div>
						<div class="info_b">
							<span class="mobile"><i></i>18353615875</span>&nbsp;&nbsp;
							<span class="email"><i></i>qin.shaoyou@hotmail.com</span>
						</div>
						<div class="mr_sns">
						<!--   -------------------社交账号     -----------------       -->
						</div>
							...
							<div class="list_show">
								...
								<div class="clearfixs">
									<div class="mr_content_l">
										<div class="l1">
											<img src="http://www.lagou.com/image1/M00/44/68/CgYXBlXVeOyATKmxAAAUhVG7imY042.png?cc=0.5880864235627262" alt="山东环球软件科技有限公司"/>
										</div>
										<div class="l2">
											<h4>山东环球软件科技有限公司</h4>
											<span>android开发实习生</span>
										</div>
									</div>
									<div class="mr_content_r">
										<span>2015.03 -- 2015.08</span>
									</div>							
								</div>
								
								<div class="mr_content_m olpf">
									<ul>
 <li>参与开发&nbsp;“环球软件 VPN管理”&nbsp;&nbsp; app</li>
 <li>参与开发 “农圣网&nbsp; 服务器数据测试 “app</li>
</ul>
								</div>	
								</div>
								<div class="mr_jobe_list">
								<div class="clearfixs">
									<div class="mr_content_l">
										<div class="l1">
											<img src="http://www.lagou.com/image1/M00/44/68/CgYXBlXVeY2AGv2yAAAUhVG7imY295.png?cc=0.8741853247212952" alt="山东环球软件科技有限公司"/>
										</div>
										<div class="l2">
											<h4>山东环球软件科技有限公司</h4>
											<span>web开发,Java培训学习</span>
										</div>
									</div>
									<div class="mr_content_r">
								...
								<div class="mr_content_m olpf">
									<ul>
 <li>参与”烟台市环保局“网站制作</li>
 <li>重点学习Java Web编程，Oracle基本操作与Tomcat&nbsp;</li>
</ul>
								</div>	
								</div>
								<div class="mr_jobe_list">
								<div class="clearfixs">
									<div class="mr_content_l">
										<div class="l1">
											<img src="http://www.lagou.com/image1/M00/44/69/CgYXBlXVe02AeRvWAAAE4Pj0iRQ387.png?cc=0.9809354053525552" alt="山东潍科软件科技有限公司"/>
										</div>
										<div class="l2">
											<h4>山东潍科软件科技有限公司</h4>
											<span>学员</span>
								...
								<div class="clearfixs mb46 mr_jobe_list">
									<div class="mr_content_l">
										<div class="l1">
											...
											<img src="http://www.lagou.com/images/schoolBadge/0bb7f845867a4f6890c9a74d3874dcec.jpeg"/>
										</div>
										<div class="l2">
											<h4>潍坊科技学院</h4>
											<span>本科 · 软件工程</span>
						...
						<div>
							...
							<div class="mr_moudle_content" id="projectList">
								...
								<div class="clearfixs">
									<div class="mr_content_l">
										<div class="l2">
											<a class="projectTitle nourl">购物类商城App开发</a>
											<p>数据测试</p>
										</div>
									</div>
									
									<div class="mr_content_r">
										<span>2015.08 -- 2015.08</span>
									</div>							
								</div>
								<div class="mr_content_m olpf">
									<p>负责手机端接口Api的数据测试</p>
							...
							<div class="mr_moudle_content">
								...
								<div class="mr_work_upload">
									<div class="mr_wu_show"> 
										<div class="mr_wu_t">
											<a href="http://www.lagou.com/image1/M00/44/6E/Cgo8PFXViG-AEnKhAACQs6g0j1k416.png" target="_blank">
												<img class="wh43" src="http://www.lagou.com/image1/M00/44/6E/Cgo8PFXViHeAP1F-AABMDGL1hE0714.png" />
											</a>
										</div>
										<div class="mr_wu_con">
											<div class="clearfixs">
												<div class="mr_content_l">
													<div class="l2">
														<span>[</span><span class="mr_work_title">动感光波哒-之-真奥义-连连看</span><span>]</span>
													</div>
												</div>
												
											</div>	
											<div class="mr_wu_con_m olpf">
												<p>&nbsp;学习的时候自己做的一个连连看小游戏，用手机里照片做的资源~~仅供娱乐</p>
<p>http://anzhuoyuan.com/app/info/appid/219025.html</p>
											</div>											
										</div>
									</div>
								</div>		
								<div class="mr_work_upload">
									<div class="mr_wu_show"> 
										<div class="mr_wu_t">
											<a href="http://www.lagou.com/image2/M00/06/33/CgpzWlX5Lz6AKEv1AAQVObAuVhA270.png" target="_blank">
												<img class="wh43" src="http://www.lagou.com/image2/M00/06/33/CgqLKVX5L0iADmHkAAMCC4f2_Vw526.png" />
											</a>
										</div>
										<div class="mr_wu_con">
											<div class="clearfixs">
												<div class="mr_content_l">
													<div class="l2">
														<span>[</span><span class="mr_work_title">咩咩天气</span><span>]</span>
													</div>
												</div>
											...
											<div class="mr_wu_con_m olpf">
												<p>安卓天气预报</p>
<p>https://github.com/qin-shaoyou/MieMie_TianQi</p>
											</div>											
										</div>
									</div>
								</div>		
						...
						<div>
							...
							<div class="mr_moudle_content clearfixs">
								<div class="mr_self_l">
									...
									<i></i>
									<img src="http://www.lagou.com/image1/M00/44/6E/Cgo8PFXViSSAG9gxAAAsFOk6PHs447.jpg" alt="秦浩雷"/>
								</div>	
								<div class="mr_self_r">
									<ul>
 <li>有思想&middot;守规矩&middot;懂自律&middot;爱交流</li>
 <li>小宇宙可持续爆发不间断</li>
 <li>追求美，追求技术，追求卓越</li>
 <li>常常喜欢跪舔牛逼的技术大牛</li>
 <li>发现更大的世界与更小的自己</li>
						...
						<div class="mr_moudle_content clearfixs mr_w604">
							<div class="expectjob_list">
								...
								<div class="mr_job_info" data-id="$!expectJobses.id">
									<ul class="clearfixs">
										<li class="mr_name_li" ><i></i><span class="mr_job_name" title="安卓开发">安卓开发</span></li>
										<li class="mr_jobtype_li"> <i></i><span class="mr_job_type" title="$!expectJobses.positionType">实习</span></li>
										<li class="mr_city_li"> <i></i><span class="mr_job_adr" title="$!expectJobses.city">潍坊</span></li>
										<li class="mr_jobrange_li" ><i></i><span class="mr_job_range" title="$!expectJobses.salarys">2k以下</span></li>
									</ul>
								</div>	
						...
						<div>
							...
							<div class="mr_moudle_content">
								<div class="mr_skill_con">
									<span class="mr_skill_name" title="Android">Android</span>
								...
								<div class="mr_skill_con">
									<span class="mr_skill_name" title="数据库">数据库</span>
									<span class="mr_skill_plan" data-skillLevel = "13">
									 <em style="width: 13%"></em>
									</span>
									<span class="mr_skill_level">了解</span>
								</div>	
								<div class="mr_skill_con">
									<span class="mr_skill_name" title="UI设计">UI设计</span>
									<span class="mr_skill_plan" data-skillLevel = "34">
								...
								<div class="mr_skill_con">
									...
									<span class="mr_skill_plan" data-skillLevel = "20">
									 <em style="width: 20%"></em>
									</span>
									<span class="mr_skill_level">熟悉</span>
								</div>	
								<div class="mr_skill_con">
									<span class="mr_skill_name" title="服务器">服务器</span>
									<span class="mr_skill_plan" data-skillLevel = "5">
									 <em style="width: 5%"></em>
									</span>
									<span class="mr_skill_level">了解</span>
								</div>	
